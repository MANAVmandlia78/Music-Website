...
<body>
    <div class="sidebar">
        ...
        <nav>
            ...
            <a href="recentsongs.php" class="nav-item">
...
<!-- GRID 1 SECTION -->
                    <div class="playlists-grid">
                        <?php $select_songs = mysqli_query($conn, "SELECT * FROM `songs` WHERE grid_type = 'grid2'");
...
<!-- GRID 3 SECTION -->
   ...
   <section class="playlist">
      <?php 
      $select_songs = mysqli_query($conn, "SELECT * FROM `songs` WHERE grid_type = 'grid3'");
      if(mysqli_num_rows($select_songs) > 0){
         while($fetch_song = mysqli_fetch_assoc($select_songs)){
      ?>
         <div class="playlist-card" data-src="uploaded_music/<?= $fetch_song['music']; ?>">
  ...
  <i class="fa-solid fa-download"></i>
        ...
        ?>
            ...
            <div class="section">
            <div class="section-header">
                <h2 class="section-title">Rap Songs</h2>
                <a href="#" class="see-all">More</a>
            </div>
            <div class="playlists-grid">
                <section class="playlist">
<!-- GRID 7 SECTION -->
   ...
   <section class="playlist">
      <?php 
      $select_songs = mysqli_query($conn, "SELECT * FROM `songs` WHERE grid_type = 'grid7'");
      if(mysqli_num_rows($select_songs) > 0){
         while($fetch_song = mysqli_fetch_assoc($select_songs)){
      ?>
         <div class="playlist-card" data-src="uploaded_music/<?= $fetch_song['music']; ?>">
      ...
      <?php
         ...
         echo "<p>No songs in Grid 7 yet.</p>";
      }
      ?>
</div>
            </div>
