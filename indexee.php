...
if(!empty($_SESSION["id"])){
    $id = $_SESSION["id"];
    $result = mysqli_query($conn, "SELECT * FROM tb_userss WHERE id= $id");
...
<body>
    <div class="sidebar">
        <a href="#" class="logo" id="hamburger-logo">
    ...
    <div class="main-content">
        ...
        <div class="section">
            <div class="section-header">
                <h2 class="section-title">Mixed for you</h2>
...
<!-- GRID 1 SECTION -->
                    <div class="playlists-grid">
                        <?php $select_songs = mysqli_query($conn, "SELECT * FROM `songes` WHERE grid_type = 'grid1'");
...
<div class="containeree">
  ...
  <div class="playlist-cardee">
    <div class="card-contentee">
      <div class="thumbnail-containeree">
        <video class="hidden-videoee" autoplay loop muted playsinline>
          <source src="Sukuna vs. Jogo (Shibuya Incident Arc) fan animation.mp4" type="video/mp4">
        </video>
      </div>
  ...
  <div class="playlist-cardee">
    ...
    <div class="preview-containeree">
      ...
      <div class="artistsee">Mrs. DARSHAN RAVAL, EK TARFA 2.0</div>
    </div>
  </div>
</div> 
          ...
          <div class="section">
            <div class="section-header">
                <h2 class="section-title">Love songs for you</h2>
                <a href="#" class="see-all">More</a>
            </div>
            <div class="playlists-grid">
                <section class="playlist">
<!-- GRID 2 SECTION -->
   ...
   <section class="playlist">
      <?php 
      $select_songs = mysqli_query($conn, "SELECT * FROM `songes` WHERE grid_type = 'grid2'");
      if(mysqli_num_rows($select_songs) > 0){
         while($fetch_song = mysqli_fetch_assoc($select_songs)){
      ?>
         <div class="playlist-card" data-src="uploaded_music/<?= $fetch_song['music']; ?>">
      ...
      <?php
         ...
         echo "<p>No songs in Grid 2 yet.</p>";
      }
      ?>
</div>
            </div>
                        ...
                        <div class="song-details-content">
                            ...
                            <div class="player-section">
                                ...
                                <div class="player-controls">
                                    ...
                                    <button class="control-btn download-btn" title="Download current song">
  <i class="fa-solid fa-download"></i>
                            ...
                            <div class="song-list">
                                ...
                                <ul class="songs">
                                    <?php 
        $select_songs = mysqli_query($conn, "SELECT * FROM `songes`");
        ...
        if(mysqli_num_rows($select_songs) > 0){
            while($fetch_song = mysqli_fetch_assoc($select_songs)){
                ...
                $duration = "3:30"; 
        ?>
                                    <li class="song-item" data-src="uploaded_music/<?= $fetch_song['music']; ?>" data-id="<?= $fetch_song['id']; ?>">
                                        <img src="<?= $album_image; ?>"
        ...
        ?>
            ...
            <div class="section">
            <div class="section-header">
                <h2 class="section-title">Party Songs</h2>
                <a href="#" class="see-all">More</a>
            </div>
            <div class="playlists-grid">
                <section class="playlist">
<!-- GRID 3 SECTION -->
   ...
   <section class="playlist">
      <?php 
      $select_songs = mysqli_query($conn, "SELECT * FROM `songes` WHERE grid_type = 'grid3'");
      if(mysqli_num_rows($select_songs) > 0){
         while($fetch_song = mysqli_fetch_assoc($select_songs)){
      ?>
         <div class="playlist-card" data-src="uploaded_music/<?= $fetch_song['music']; ?>">
      ...
      <?php
         ...
         echo "<p>No songs in Grid 3 yet.</p>";
      }
      ?>
</div>
            </div>
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  const containeree = document.querySelectorAll('.containeree');
...
document.getElementById('hamburger-logo').addEventListener('click', function (e) {
