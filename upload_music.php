...
if(isset($_POST['submit'])){
   ...
   $grid_type = filter_var($grid_type, FILTER_SANITIZE_STRING);
   ...
   if($music_size > 100000000){
      ...
      $upload_music = $conn->prepare("INSERT INTO `songes`(name, artist, album, music, grid_type) VALUES(?,?,?,?,?)");
      $upload_music->execute([$name, $artist, $album, $music, $grid_type]);
...
<section class="form-container">
   ...
   <form action="" method="POST" enctype="multipart/form-data">
      ...
      <p>select grid/category <span>*</span></p>
      <select name="grid_type" class="box" required>
         ...
         <option value="grid4">Grid 5</option>
         <option value="grid4">Grid 6</option>
         <option value="grid4">Grid 7 </option>
      </select>


      <input type="submit" value="upload music" class="btn" name="submit">
      <a href="indexee.php" class="option-btn">go to home</a>
   </form>
